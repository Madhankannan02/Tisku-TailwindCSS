 ...
 return(
  <main className="flex
    ...
    gap-7">
     ...
     <HeroImage image={"Rectangle 2.png"} />
     ...
     flex-col">
      ...
      gap-12">
       ...
       font-itcbook
       font-light
       w-[65%]">Step back into Fashion and discover a world of premium, hand-crafted fashion pieces tailored to elevate your individuality.
       </p>
       </div>
       </div>
      ...
      <div className="inputs flex gap-6 flex-col w-full">
        ...
        <InputElement image={"email.svg"} placeholder={"Enter your email"} type={"text"}/>
  
        <InputElement image={"password.svg"} placeholder={"Enter your password"} type={"password"} />
      ...
      text-3
      text-black">Don't have an account? <Link to="/signup"> <span className="font-itcbook
      font-bold
      hover:underline
      hover:cursor-pointer">Sign Up</span> </Link></p>
      </div>
